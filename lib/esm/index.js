...
import { Form, TextField, SelectField, SubmitButton, RadioField, TextAreaField, CheckBoxField, } from "./components/FormFields.tsx";
var fieldMap = {
    text: TextField,
    select: SelectField,
...
var App = function (_a) {
    var formData = _a.formData, buttonTitle = _a.buttonTitle, onSubmit = _a.onSubmit;
    var initialValues = {};
    ...
    return (React.createElement(Form, { enableReinitialize: true, validationSchema: validateSchema, initialValues: values, onSubmit: _onSubmit },
        ...
        React.createElement(SubmitButton, { title: buttonTitle ? buttonTitle : "Submit" })));
};
export default App;
